...
template <typename T>
class Searchsorted2dOp : public OpKernel {
 public:
  explicit Searchsorted2dOp(OpKernelConstruction* context) : OpKernel(context) {}
...
#define REGISTER_KERNEL(type)                                              \
  REGISTER_KERNEL_BUILDER(                                                 \
      Name("Searchsorted2d").Device(DEVICE_CPU).TypeConstraint<type>("T"),   \
      Searchsorted2dOp<type>)
