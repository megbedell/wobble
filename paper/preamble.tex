...
\definecolor{nicered}{RGB}{255, 77, 77}
\newcommand{\changed}[1]{\textcolor{nicered}{#1}}

% math
\newcommand{\Lone}[2]{\ensuremath{#1\| \mvec{#2} \|^1_1}}
\newcommand{\Ltwo}[2]{\ensuremath{#1\| \mvec{#2} \|^2_2}}
\newcommand{\ssvec}[1]{{\ensuremath{\mathit{\mathsf{#1}}}}}
\newcommand{\mmatrix}[1]{\ensuremath{\boldsymbol{#1}}}
\newcommand{\mvec}[1]{\ensuremath{\boldsymbol{#1}}}
