...
In detail, this approximation is incorrect, but it should not have a large effect on our results; see \citet{Wright2014} and \citet{Wright2019} for further discussion.}
...
Technically a small bias is introduced by taking the logarithm of the flux, but this bias is very small at the relevant signal-to-noise ratios; furthermore, the small bias \changed{in flux is unlikely to map strongly onto the radial velocities obtained.}%acts in the flux direction, not the radial-velocity direction.
