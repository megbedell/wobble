...
We fit a Keplerian signal with six free parameters (period $P$, \RV semi-amplitude $K$, eccentricity $e$, argument of periastron $\omega$, time of periastron $T_p$, and \RV offset $c$) using a simple $\chi^2$ optimization with \code{scipy.optimize.leastsq}. 
